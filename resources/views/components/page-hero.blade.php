...
<section data-hero {{ $attributes->class(['relative flex flex-col overflow-hidden bg-brand-navy-deep', $heights[$size]]) }}>
    ...
    <div class="pointer-events-none absolute inset-0 bg-gradient-to-r from-brand-navy-deep/95 via-brand-navy-deep/80 to-brand-navy-deep/35"></div>
    <div class="pointer-events-none absolute inset-x-0 bottom-0 h-[45%] bg-gradient-to-t from-brand-navy-deep via-brand-navy-deep/85 to-transparent"></div>
    <div class="pointer-events-none absolute inset-x-0 top-0 h-40 bg-gradient-to-b from-brand-navy-deep/70 to-transparent"></div>
