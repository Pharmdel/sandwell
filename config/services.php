...
return [
    ...
    'services' => [
        ...
        'menu' => [
            ...
            'description' => 'Book your flu and Covid-19 vaccination across the Sandwell Pharmacy Group. Free NHS jabs for eligible patients, private flu jabs £30.',
            'h1' => 'Flu & Covid-19 vaccinations, booked in under a minute',
            'highlight' => 'in under a minute',
            'intro' => 'Free NHS flu and Covid-19 jabs for eligible patients across the Sandwell Pharmacy Group — plus private flu jabs for £30. Both jabs can be given together in one visit.',
            'badges' => [
        ...
        'menu' => [
            ...
            'description' => 'Start or continue oral contraception free on the NHS across the Sandwell Pharmacy Group, with a private pharmacist consultation. No GP appointment needed.',
            'h1' => 'Contraception services',
            'highlight' => 'services',
            'intro' => 'Emergency hormonal contraception and ongoing daily contraception — both available free on the NHS from the Sandwell Pharmacy Group. Confidential, non-judgemental care.',
            'badges' => [
                'Free on the NHS',
        ...
        'menu' => [
            ...
            'description' => 'Earache and ear infections assessed and treated across the Sandwell Pharmacy Group — free on the NHS for ages 1–17 under Pharmacy First. No GP appointment.',
            ...
            'about' => [
                ...
                'paras' => [
                    ...
                    'Adults with earache, outer-ear infections or wax-related blockages can be seen privately — and if wax is the culprit, ear syringing is available at our Sandwell Pharmacy branch.',
                ],
            ],
            'cta' => [
        ...
        'menu' => [
            ...
            'description' => 'Weekly MDS blister packs from the Sandwell Pharmacy Group — medication organised by day and time. Free standard waiting list or £25/month priority service.',
        ...
        'menu' => [
            ...
            'description' => 'Free NHS New Medicine Service across the Sandwell Pharmacy Group — one-to-one pharmacist check-ins when you start a new medicine for a long-term condition.',
        ...
        'menu' => [
            ...
            'description' => 'Just out of hospital? The free NHS Discharge Medicines Service across the Sandwell Pharmacy Group — our pharmacist reviews your medicine changes and keeps you safe.',
        ...
        'menu' => [
            ...
            'description' => 'Tell Sandwell Pharmacy Group which medicines you already have, have stopped or want paused — so we only order what you actually need.',
        ...
        'menu' => [
            ...
            'description' => 'Pharmacist-led acne treatment across the Sandwell Pharmacy Group — evidence-based treatment plans for teens and adults with regular reviews.',
        ...
        'menu' => [
            ...
            'description' => 'Discreet, pharmacist-led male hair loss treatment across the Sandwell Pharmacy Group. Private consultation, clinically proven treatments and ongoing reviews.',
        ...
        'menu' => [
            ...
            'description' => 'Delay your period safely for holidays, weddings or events with a quick, confidential pharmacist consultation across the Sandwell Pharmacy Group.',
        ...
        'menu' => [
            ...
            'description' => 'Private vitamin B12 maintenance injections across the Sandwell Pharmacy Group — £30 per dose, administered by our pharmacist. No GP referral needed.',
        ...
        'menu' => [
            ...
            'description' => 'Private chickenpox (varicella) vaccination across the Sandwell Pharmacy Group. Two-dose course for children and adults, given by our trained pharmacist.',
